...
Currency = ["BTCUSDT", 'ETHUSDT'
         ...
         'MATICUSDT', 'LTCUSDT', 'CHZUSDT', 'BCHUSDT',
         'FTMUSDT', 'DOGEUSDT', 'BNBUSDT','NEARUSDT',
         'GMTUSDT', 'DASHUSDT', 'AVAXUSDT']
...
#             print(price[name][i],df['date'][i],'Long')
        ...
        try:
            ...
            bot.send_message(75842418, 'something wrong!!')
    else :
...
#bot.send_message(75842418, 'Great')
